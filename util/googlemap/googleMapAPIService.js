...
class GoogleMapAPIService {
    ...
    async downloadPhoto(photoReference, restaurant_id) {
        const apiUrl = `https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${photoReference}`;
        ...
        const filePath =  __dirname + `../../../public/media/restaurantimage/${filename}`;
